...
export const blogPosts: BlogPost[] = [
  // English Posts
  {
    ...
    date: "2025-11-01",
    excerpt:
      "Discover proven strategies to cut your development costs without sacrificing quality. Learn from real case studies and actionable insights.",
    language: "en",
  ...
  },
  {
    ...
    date: "2025-10-28",
    excerpt:
      "Master the latest React performance optimization techniques including concurrent rendering, code splitting, and lazy loading strategies.",
    language: "en",
    author: "CodeNovex Team",
  ...
  },
  {
    ...
    date: "2025-10-20",
    excerpt:
      "A comprehensive guide to selecting the perfect technology stack for your startup. Compare frameworks, databases, and deployment options.",
    language: "en",
    author: "CodeNovex Team",
  ...
  // Georgian Posts
  {
    ...
    title:
      "როგორ შევამციროთ პროგრამული უზრუნველყოფის განვითარების ხარჯები 40%-ით",
    date: "2025-11-01",
    excerpt:
      "აღმოაჩინეთ დამტკიცებული სტრატეგიები თქვენი განვითარების ხარჯების შესამცირებლად ხარისხის შენარჩუნებით. ისწავლეთ რეალური შემთხვევების შესწავლიდან.",
    language: "ka",
  ...
  },
  {
    ...
    date: "2025-10-28",
    excerpt:
      "დაეუფლეთ უახლეს React-ის შესრულების ოპტიმიზაციის ტექნიკას, მათ შორის კონკურენტულ რენდერინგს, კოდის დაყოფას და ზარმაც ჩატვირთვის სტრატეგიებს.",
    language: "ka",
    author: "CodeNovex გუნდი",
  ...
  },
  {
    ...
    date: "2025-10-20",
    excerpt:
      "ყოვლისმომცველი გზამკვლევი თქვენი სტარტაპისთვის იდეალური ტექნოლოგიური სტეკის შერჩევისთვის. შეადარეთ ფრეიმვორკები, მონაცემთა ბაზები და განლაგების ვარიანტები.",
    language: "ka",
    author: "CodeNovex გუნდი",
...
export const getPostsByCategory = (
  ...
  return getPostsByLanguage(language).filter(
